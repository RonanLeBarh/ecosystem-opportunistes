...
export const CONFIG = {
    ...
    SLOW_FACTOR: 30,                  // ralentit uniquement les petites vitesses 5 lent mais fluide 20 ultra lent
    ...
    GENE_LIMITS: {
        ...
        MUTATION_RATE_MIN: 0.05,  // 5% au lieu de 1%
        MUTATION_RATE_MAX: 0.3,   // 30% au lieu de 10%
